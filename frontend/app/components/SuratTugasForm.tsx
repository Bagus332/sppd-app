  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-6xl mx-auto p-8 space-y-8 bg-neutral-100/90 backdrop-blur-sm rounded-xl shadow-xl border border-neutral-300">
      <div className="space-y-2">
        <h2 className="text-2xl font-bold bg-linear-to-r from-[#5c7a54] to-[#6b8c62] bg-clip-text text-transparent">Data Surat Tugas</h2>
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center border-t border-neutral-300 pt-6">
            <h2 className="text-2xl font-bold bg-linear-to-r from-[#5c7a54] to-[#6b8c62] bg-clip-text text-transparent">Daftar Pegawai ({fields.length})</h2>
            <button
                type="button"
      ...
      <div className="flex flex-col items-center gap-4 mt-6">
        <div className="flex items-center justify-end w-full gap-4">
          ...
          <button
            ...
            className="px-8 py-3 bg-linear-to-r from-[#5c7a54] to-[#6b8c62] text-white rounded-lg shadow-lg hover:from-[#485f41] hover:to-[#5c7a54] focus:outline-none focus:ring-2 focus:ring-[#5c7a54] disabled:from-[#7b9674] disabled:to-[#6b8563] transition-all duration-200 flex items-center justify-center gap-2 font-medium"
          >
            {isSubmitting ? (
              <>
